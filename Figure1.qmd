...
```{r fig.width = 7, fig.height = 4.8, echo=TRUE, eval=FALSE}
p1
```
...
```{r cache=FALSE, warning=FALSE, message=FALSE, echo=TRUE, eval=FALSE}
...
```{r echo=FALSE, fig.width = 16, fig.height = 8, echo=TRUE, eval=FALSE}
dot1
```

## (b) Cell type proportion

```{r message=FALSE, cache=FALSE, echo=TRUE, eval=FALSE}
...
```{r echo=FALSE, fig.width = 4, fig.height = 5, fig.align='center', echo=TRUE, eval=FALSE}
a
```

Proportion change between adjacent tissue and tumor

```{r warning=FALSE, message=FALSE, cache=FALSE, echo=TRUE, eval=FALSE}
...
```{r echo=FALSE, fig.width = 2, fig.height = 6, fig.align='center', echo=TRUE, eval=FALSE}
p2
```
...
```{r echo=FALSE, fig.width = 6, fig.height = 4, echo=TRUE, eval=FALSE}
box1
```
...
```{r echo=FALSE, fig.width = 7, fig.height = 6, echo=TRUE, eval=FALSE}
dim1
```
...
```{r echo=FALSE, fig.width = 9, fig.height = 5, echo=TRUE, eval=FALSE}
dot2
```
...
```{r echo=FALSE, fig.width = 6, fig.height = 5, echo=TRUE, eval=FALSE}
box2
```
...
```{r echo=FALSE, fig.width = 5, fig.height = 4.8, echo=TRUE, eval=FALSE}
dim1
```
...
```{r echo=FALSE, fig.width = 7, fig.height = 10, echo=TRUE, eval=FALSE}
tile1
```
...
```{r echo=FALSE, fig.width = 7, fig.height = 3, echo=TRUE, eval=FALSE}
vln4
```
...
```{r echo=FALSE, fig.width = 10, fig.height = 3, echo=TRUE, eval=FALSE}
vln5
```
...
```{r echo=FALSE, fig.width = 5, fig.height = 4, echo=TRUE, eval=FALSE}
p1
```

### Fig.S1f

```{r warning=FALSE, message=FALSE, fig.width = 5, fig.height = 4, echo=TRUE, eval=FALSE}
# figS1f -----
...
```{r echo=FALSE, fig.width = 8, fig.height = 12, echo=TRUE, eval=FALSE}
dot1
```
...
```{r echo=FALSE, message=FALSE, echo=TRUE, eval=FALSE}
ComplexHeatmap::draw(htp_lst)
```
