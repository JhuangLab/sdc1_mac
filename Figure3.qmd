...
```{r echo=FALSE, out.width = '800px', out.height='600px', fig.align='center', echo=TRUE, eval=FALSE}
print(htp1)
```
...
```{r echo=FALSE, fig.width = 6, fig.height = 3, echo=TRUE, eval=FALSE}
p
```
...
```{r echo=FALSE, echo=TRUE, eval=FALSE}
print(htkm)
```
...
```{r echo=FALSE, fig.width = 6, fig.height = 6, fig.align='center', echo=TRUE, eval=FALSE}
p
```
...
```{r echo=FALSE, fig.width = 10, fig.height = 8, fig.align='center', echo=TRUE, eval=FALSE}
dot2
```
